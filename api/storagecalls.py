...
# AWS IPFS CLUSTER UPDATE image
def upload_image(file):
    # BIT IPFS CLUSTER API REQUESTS...
    # url = 'https://d1qtdhmnudqt77.cloudfront.net:443/id'  # To get Node id (GET)
    # url = 'https://d1qtdhmnudqt77.cloudfront.net:443/version'  # To get version(GET)
    url = 'https://d1qtdhmnudqt77.cloudfront.net:443/add'  # To add data(POST)
    # url = 'https://d1qtdhmnudqt77.cloudfront.net:443/pins'  # To get all pins in CLUSTER(GET)
    username = 'bitipfs'
    password = 'Bitipfs@2023'
    auth = base64.b64encode(f'{username}:{password}'.encode('utf-8')).decode('utf-8')
    files = {"file": file}
    response = requests.post(url, files=files, headers={'Authorization': f'Basic {auth}'})
    # print(response.json())
    cid = response.json()["cid"]
    # file_url = "https://" + cid + ".ipfs.dweb.link"
    file_url = "https://d3a5rnyctxz7gc.cloudfront.net/ipfs/" + cid
    # print(file_url)
    return file_url

# AWS IPFS CLUSTER UPDATE metadata
def upload_metadata(filepath):
    # BIT IPFS CLUSTER API REQUESTS...
    # url = 'https://d1qtdhmnudqt77.cloudfront.net:443/id'  # To get Node id (GET)
    # url = 'https://d1qtdhmnudqt77.cloudfront.net:443/version'  # To get version(GET)
